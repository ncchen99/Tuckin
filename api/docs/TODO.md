...
- [x] [前端] 選擇餐廳葉面
  ...
  - [x] 點擊投票後，送出 API 投票
  - [ ] 回傳的餐廳資訊建構聚餐資訊頁面
  - [ ] 持久化儲存group ID event ID restaurant info ?
- [ ] [前端] 取得聚餐資訊
    - [ ] 取得聚餐資訊
    - [ ] 持久化儲存dining_events，不同頁面共用
...
- [x] [API] 刪除非必要端點
- [ ] [API] 刪除週期資料 rating_sessions、restaurant_votes、matching_groups、dining_events、user_matching_info，遷移 dining_events 資料(包含 ids)
- [ ] [API] 定時 API 們加入時間檢查
